...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionGet_Your_Streak = new QAction(MainWindow);
        actionGet_Your_Streak->setObjectName(QString::fromUtf8("actionGet_Your_Streak"));
        ...
        menuFile->addSeparator();
        menuFile->addAction(actionGet_Your_Streak);
        menuFile->addSeparator();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionGet_Your_Streak->setText(QApplication::translate("MainWindow", "Get Your Streak", 0, QApplication::UnicodeUTF8));
